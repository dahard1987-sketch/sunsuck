...
Copyright (c) 2019 Andrew Dillon. Licensed under the MIT License. See `LICENSE-pdf-lib.md`.

Source: https://github.com/Hopding/pdf-lib

## @pdf-lib/fontkit 1.1.1

Copyright (c) Andrew Dillon and fontkit contributors. Distributed under the MIT License as declared by the package metadata.
